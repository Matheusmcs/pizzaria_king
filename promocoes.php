...
<body class="body1">
    <script>
        ...
        function calcularPreco(pizzaNome) {
            ...
            var preco_unitario = parseFloat(input.getAttribute('data-Valor')); // Obter o preço da pizza
                    ...
                    <div class="div-pedido">
                        ...
                        <div class="pedido">
                            ...
                            <input type="number" readonly="" class="item-quantidade" name="quantidade_<?php echo strtolower($pizza_nome); ?>"
                                ...
                                data-Valor="<?php echo $pizza_preco; ?>"> <!-- Adicione o preço como atributo de dados -->
