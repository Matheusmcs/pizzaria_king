...
<header>
    ...
    <main class="main-principal">
        <form action="carrinho.php" method="post">
            <div class="row">
                ...
                <div class="col-md-4 div">
                    <div class="div-pedido">
                        ...
                        <h2 class="h2-pedidos">Pizza - <?php echo $pizza_nome; ?></h2>
                        <p class="p-pedidos"><?php echo $pizza_nome; ?>, Cebola, Molho de tomate.</p>
                        <div class="pedido">
                            <h2>Preço R$<?php echo $pizza_preco; ?></h2>
                            <h2>Quantidade</h2>
                            <input type="number" class="item-quantidade" name="quantidade_<?php echo strtolower($pizza_nome); ?>"
            ...
            <input class="adici" type="submit" value="adicionar ao carrinho">
        </form>
    </main>
</body>
