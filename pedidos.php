      ...
      <div class="row">
        <div class="col-md-4 div"> <!--1-->
          <div class="div-pedido">
            ...
            <div class="pedido">
              <h2>Preço R$<?php echo $pizza_calabresa ?></h2>
              <h2>quantidade</h2>
              <input type="number" onclick="calcularPizza_calabresa()" class="item-quantidade" name="quantidade_calabresa" id="quantidade_calabresa" value="0" min="0">
              <p>Preço total: R$ <span id="preco_total_calabresa"><?php echo $preco_total_calabresa ?></span></p>
        ...
        <div class="col-md-4 div"> <!--2-->
          <div class="div-pedido">
            ...
            <p class="p-pedidos">pizza mais amada do brasil, calabresa, cebola, molho de tomate, musareala.</p>
            <div class="pedido">
              <h2>Preço R$<?php echo $pizza_peperoni ?></h2>
              <h2>quantidade</h2>
              <input type="number" class="item-quantidade" name="quantidade_peperoni" id="quantidade_peperoni" value="0" min="0">
              <p>Preço total: R$ <span id="preco_total_peperoni"><?php echo $preco_total_peperoni ?></span></p>
          ...
          <div class="col-md-4 div"> <!--3-->
            <div class="div-pedido">
              ...
              <p class="p-pedidos">pizza mais amada do brasil, calabresa, cebola, molho de tomate, musareala.</p>
              <div class="pedido">
                <h2>Preço R$<?php echo $pizza_marguerita ?></h2>
                <h2>quantidade</h2>
                <input type="number" class="item-quantidade" name="quantidade_marguerita" id="quantidade_marguerita" value="0" min="0">
                <p>Preço total: R$ <span id="preco_total_marguerita"><?php echo $preco_total_marguerita ?></span></p>
          ...
          <div class="div-pedido">
            ...
            <p class="p-pedidos">pizza mais amada do brasil, calabresa, cebola, molho de tomate, musareala.</p>
            <div class="pedido">
                <h2>Preço R$<?php echo $pizza_portuguesa ?></h2>
                <h2>quantidade</h2>
                <input type="number" class="item-quantidade" name="quantidade_portuguesa" id="quantidade_portuguesa" value="0" min="0">
                <p>Preço total: R$ <span id="preco_total_portuguesa"><?php echo $preco_total_portuguesa ?></span></p>
          ...
          <div class="div-pedido">
            ...
            <h2 class="h2-pedidos">pizza-calabresa</h2>
                <p class="p-pedidos">pizza mais amada do brasil, calabresa, cebola, molho de tomate, musareala.</p>
                <div class="pedido">
                  <h2>Preço R$<?php echo $pizza_chocoboom ?></h2>
                  <h2>quantidade</h2>
                  <input type="number" class="item-quantidade" name="quantidade_chocoboom" id="quantidade_chocoboom" value="0" min="0">
                  <p>Preço total: R$ <span id="preco_total_chocoboom"><?php echo $preco_total_chocoboom ?></span></p>
            ...
            <div class="div-pedido">
              ...
              <p class="p-pedidos">pizza mais amada do brasil, calabresa, cebola, molho de tomate, musareala.</p>
              <div class="pedido">
                <h2>Preço R$<?php echo $pizza_frango_requeijao ?></h2>
                <h2>quantidade</h2>
                <input type="number" class="item-quantidade" name="quantidade_frango_requeijao" id="quantidade_frango_requeijao" value="0" min="0">
                <p>Preço total: R$ <span id="preco_total_frango_requeijao"><?php echo $preco_total_frango_requeijao ?></span></p>
                </div>
              </div>
            </div>
          </div>
